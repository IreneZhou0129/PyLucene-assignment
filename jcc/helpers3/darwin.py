...
if sys.platform == "darwin":
    ...
    try:
        ...
        if process.returncode == 0:
            ...
            if os.path.exists(os.path.join(_path, "include", "jni.h")):
                JAVAHOME = _path
                print('darwin.py found JAVAHOME =', JAVAHOME, file=sys.stderr)
        else:
    ...
    #irene: /System/Library/Java/JavaVirtualMachines/jdk-17.0.2.jdk/Contents/Home/include/jni.h
    #irene: 
    # JAVAFRAMEWORKS = '/System/Library/Java/JavaVirtualMachines/jdk-17.0.2.jdk/Contents/Home/include'
